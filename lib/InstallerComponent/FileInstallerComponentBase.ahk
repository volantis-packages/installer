class FileInstallerComponentBase extends InstallerComponentBase {
    ...
    __New(appName, version, destPath, appState, stateKey, cache, versionSorter, parentStateKey := "", overwrite := false, tmpDir := "", onlyCompiled := false) {
        this.destPath := destPath
        super.__New(appName, version, appState, stateKey, cache, versionSorter, parentStateKey, overwrite, tmpDir, onlyCompiled)
